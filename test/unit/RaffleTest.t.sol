...
contract RaffleTest is Test {
    ...
    // This test failes when on sepolia testnet : needs fixing
    ...
    {
        // Act
        // The line below saves all of the log output in this
        vm.recordLogs();
    ...
    // Fuzz test: This test is executed many times with different values for uint256 randomRequestId
